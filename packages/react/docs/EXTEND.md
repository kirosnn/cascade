# Cascade React Component Extension

The `extend` function allows you to add custom renderable components to the Cascade React reconciler, similar to how `@react-three/fiber` allows extending Three.js objects.
...
- Extended components must extend from Cascade's core renderable classes

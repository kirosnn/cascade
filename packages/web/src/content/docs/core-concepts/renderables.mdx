...
```typescript
import { createCliRenderer, TextRenderable, BoxRenderable } from "@cascade/core"
...
Cascade provides these built-in renderables:
...
```typescript
import { RenderableEvents } from "@cascade/core"

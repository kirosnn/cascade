---
title: React
description: Build terminal UIs with React and Cascade
order: 2
---
...
Cascade React provides JSX intrinsic elements that map to core renderables:
...
```tsx
import { useOnResize } from "@cascade/react"
...
```tsx
import { BoxRenderable, createCliRenderer, type BoxOptions, type RenderContext } from "@cascade/core"
...
Cascade React supports React DevTools for debugging:

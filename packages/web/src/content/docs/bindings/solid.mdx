---
title: Solid.js
description: Build terminal UIs with Solid.js and Cascade
order: 1
---

# Solid.js bindings

Build terminal user interfaces with Solid.js's fine-grained reactivity and Cascade.
...
Cascade Solid provides JSX intrinsic elements that map to core renderables.
...
```tsx
import { onResize } from "@cascade/solid"
...
```tsx
import { useTerminalDimensions } from "@cascade/solid"
...
```tsx
import { usePaste } from "@cascade/solid"
...
```tsx
import { useSelectionHandler } from "@cascade/solid"
...
```tsx
import { useTimeline } from "@cascade/solid"
...
```tsx
import { Portal, useRenderer } from "@cascade/solid"
...
```tsx
import { render, useKeyboard } from "@cascade/solid"
import { createSignal } from "solid-js"

...
```typescript
import { TextRenderable, createCliRenderer } from "@cascade/core"
...
```typescript
import { Text, createCliRenderer } from "@cascade/core"
...
```typescript
import { TextRenderable, TextAttributes } from "@cascade/core"
...
```typescript
import { TextRenderable, t, bold, underline, fg, bg, italic } from "@cascade/core"
...
```typescript
import { t, bold, dim, italic, underline, blink, reverse, strikethrough, fg, bg } from "@cascade/core"
...
```typescript
import { Text, Box, t, bold, fg } from "@cascade/core"

...
description: Install Cascade and create your first terminal UI
order: 1
---
...
Cascade is currently [Bun](https://bun.sh) exclusive but Deno and Node support in-progress.

```bash
mkdir my-tui && cd my-tui
bun init -y
bun add @cascade/core
```
...
```typescript
import { createCliRenderer, Text } from "@cascade/core"
...
```typescript
import { createCliRenderer, Box, Text } from "@cascade/core"

...
function TodoApp() {
  ...
  },
  {
    ...
    code: `# Cascade Documentation

## Getting Started

Cascade is a modern terminal UI framework built on **tree-sitter** and WebGPU.
...
\`\`\`typescript
import { createCliRenderer, BoxRenderable } from 'cascade';
...
For more info, visit [github.com/cascade](https://github.com)`,
  },
  {
    name: "Zig",
